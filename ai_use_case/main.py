...
from builder.ecologits_builder import GenAIModel
...
meta_llama = GenAIModel("huggingface_hub", "meta-llama/Meta-Llama-3-8B-Instruct", gpu_server)
mistral_7b = GenAIModel("huggingface_hub", "mistralai/Mistral-7B-Instruct-v0.3", gpu_server)
mistral_8x = GenAIModel("huggingface_hub", "mistralai/Mixtral-8x7B-Instruct-v0.1", gpu_server)

job_simple_chat = mistral_7b.job(hypothesis_token_per_simple_chat)
job_doc_chat = meta_llama.job(hypothesis_token_per_chat_on_a_document)
job_use_rag = mistral_8x.job(hypothesis_token_on_use_of_rag)
job_fill_rag = mistral_8x.job(hypothesis_nb_token_to_fill_rag)
