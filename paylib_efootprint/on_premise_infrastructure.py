...
preprod_uj = UserJourney(
    "Preprod UJ", uj_steps=[
        UserJourneyStep(
            "daily usage of preprod", user_time_spent=SourceValue(7 * u.hour / u.uj),
            jobs=[Job("job daily preprod usage", preprod_service,
                      data_download=SourceValue(1 * u.GB / u.uj),
                      data_upload=SourceValue(0 * u.GB / u.uj),
                      request_duration=SourceValue(16 * u.hour),
                      cpu_needed=SourceValue(5 * u.core / u.uj),
